...
export function ChannelScreen({
  ...
  const currentAgentId = currentIdentity?.agentId;
  ...
  } = useActiveChannelHeader(activeChannel, currentAgentId);
  ...
  const isSinglePanelView = isNarrowPanelViewport && hasAuxiliaryPanel;
